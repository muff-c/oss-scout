import type { RankedIssue, RiskLevel, ScoreOptions, ScoreSignal, ScoutIssue } from "./types.js";
...
export function scoreIssue(issue: ScoutIssue, options: ScoreOptions = {}): RankedIssue {
...
export function rankIssues(issues: ScoutIssue[], options: ScoreOptions = {}): RankedIssue[] {
  return issues
...
function riskLevelFor(score: number, signals: ScoreSignal[]): RiskLevel {
...
function newestFirst(leftUpdatedAt: string, rightUpdatedAt: string): number {
